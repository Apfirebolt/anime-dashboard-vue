  ...
  <div class="h-full flex flex-col">
    ...
    <header class="flex-shrink-0 relative h-16 bg-white flex items-center">
      ...
      >
        <div class="min-w-0 flex-1">
          ...
          >
            <label for="desktop-search" class="sr-only">Search Manga</label>
            <input
              id="desktop-search"
              type="search"
    ...
    <div class="min-h-0 overflow-hidden">
      ...
      <main class="min-w-0 border-t border-gray-200">
        ...
        >
          <Pagination
            v-if="mangaList && mangaList.pagination"
            :totalPages="mangaList.pagination.last_visible_page"
            :currentPage="mangaList.pagination.current_page"
            :nextPage="mangaList.pagination.has_next_page"
...
import { useManga } from "../store/manga";
...
const mangaList = computed(() => manga.getMangaList);
const isLoadingMangaList = computed(() => manga.isLoading);
